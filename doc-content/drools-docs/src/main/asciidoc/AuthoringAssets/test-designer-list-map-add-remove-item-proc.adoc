...
[NOTE]
====
You can not use collection editor to define the map values for DMN-based test scenario. To define the map values, do the following:

* Add a fact.
* Use the expression with the prefix `#`.
====
