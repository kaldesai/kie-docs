...
ifdef::PAM[]
= Configuring embedded {PROCESS_ENGINE} and {DECISION_ENGINE} in {WEBLOGIC}.
endif::[]

ifdef::DM[]
= Configuring embedded {DECISION_ENGINE} in {WEBLOGIC}
endif::[]

ifdef::PAM[]
This section describes how to setup embedded {PROCESS_ENGINE} and {DECISION_ENGINE} in {WEBLOGIC}.
endif::[]

ifdef::DM[]
This section describes how to setup embedded {DECISION_ENGINE} in {WEBLOGIC}.
endif::[]
...
* For {WEBLOGIC}, user needs to declare the following hibernate dependencies in the `pom.xml` file:
+
