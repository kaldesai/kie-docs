...
ifdef::PAM[]
An embedded engine is a light-weight work flow engine and rule engine that allows you to execute your decisions and business processes. An embedded engine can be part of your {PRODUCT_PAM} application or they can be deployed as a service, for example in the cloud. This section describes how to setup an embedded {PROCESS_ENGINE} or {DECISION_ENGINE} in {WEBLOGIC}.
endif::[]
ifdef::DM[]
A {DECISION_ENGINE} is a light-weight rule engine that allows you to execute your decisions. A {DECISION_ENGINE} can be part of your {PRODUCT_DM} application or they can be deployed as a service, for example in the cloud. This section describes how to setup an embedded {DECISION_ENGINE} in {WEBLOGIC}.
endif::[]
