...
An embedded engine is a light-weight work-flow engines and rule engine which executes your decisions and business processes. They can be embedded as part of your application or deployed as a service possibly in the cloud.

ifdef::PAM[]
This section describes how to setup an embedded {PROCESS_ENGINE} and {DECISION_ENGINE} in {WEBLOGIC}.
endif::[]
ifdef::DM[]
This section describes how to setup an embedded {DECISION_ENGINE} in {WEBLOGIC}.
endif::[]
