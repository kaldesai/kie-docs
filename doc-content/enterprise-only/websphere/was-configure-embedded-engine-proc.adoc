...
ifdef::PAM[]
= Configuring embedded {PROCESS_ENGINE} and {DECISION_ENGINE} in {WEBSPHERE_SHORT}.
endif::[]

ifdef::DM[]
= Configuring embedded {DECISION_ENGINE} in {WEBSPHERE_SHORT}
endif::[]

ifdef::PAM[]
This section describes how to setup embedded {PROCESS_ENGINE} and {DECISION_ENGINE} in {WEBSPHERE_SHORT}.
endif::[]

ifdef::DM[]
This section describes how to setup embedded {DECISION_ENGINE} in {WEBSPHERE_SHORT}.
endif::[]
...
* For {WEBSPHERE_SHORT} user needs to declare the following hibernate dependencies in the `pom.xml` file:
+
[id='hibernate_dependencies']
.Hibernate dependencies in {PROCESS_ENGINE}
[source,xml]
----
<dependencyManagement>
  <dependencies>
...
[NOTE]
====
The hibernate version override is applicable only if the {PROCESS_ENGINE} is used.
====
...
[NOTE]
====
{DECISION_ENGINE} does not require hibernate version override.
====
