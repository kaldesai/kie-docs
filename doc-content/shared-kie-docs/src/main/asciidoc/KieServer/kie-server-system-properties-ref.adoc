[id='kie-server-system-properties-ref']
...
|URL
|N/A
|URL is used to load a Java Cryptography Extension KeyStore (JCEKS). For example, `file:///home/kie/keystores/keystore.jceks`.
