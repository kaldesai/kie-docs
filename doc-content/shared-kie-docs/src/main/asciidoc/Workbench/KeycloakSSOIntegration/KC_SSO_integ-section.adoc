...
{CENTRAL} provides an administration area which provides user, group and role management features. For more information, see xref:con-business-central-user-management[User and group management] and see xref:con-business-central-security-management[Security management] section.
