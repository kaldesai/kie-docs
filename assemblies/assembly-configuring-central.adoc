...
include::{shared-dir}/Workbench/SecurityManagement/managing-business-central-user-and-group-management-con.adoc[leveloffset=+1]
include::{shared-dir}/Workbench/SecurityManagement/business-central-settings-creating-new-users-proc.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/managing-business-central-editing-users-proc.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/managing-business-central-creating-groups-proc.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/managing-business-central-editing-groups-proc.adoc[leveloffset=+2]

include::{shared-dir}/Workbench/SecurityManagement/business-central-security-management-con.adoc[leveloffset=+1]
//include::{enterprise-dir}/admin-and-config/business-central-settings-security-con.adoc[leveloffset=+1]
include::{shared-dir}/Workbench/SecurityManagement/business-central-settings-security-policy-con.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/business-central-security-management-provider-con.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/business-central-configuring-EAP-security-management-provider-proc.adoc[leveloffset=+3]
include::{shared-dir}/Workbench/SecurityManagement/business-central-configuring-tomcat-security-management-provider-proc.adoc[leveloffset=+3]
include::{shared-dir}/Workbench/SecurityManagement/business-central-security-management-permissions-con.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/business-central-settings-changing-permissions-proc.adoc[leveloffset=+3]
include::{shared-dir}/Workbench/SecurityManagement/business-central-settings-changing-home-proc.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/business-central-settings-setting-priorities-proc.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/business-central-enabling-security-management-proc.adoc[leveloffset=+2]
include::{shared-dir}/Workbench/SecurityManagement/business-central-disabling-security-management-proc.adoc[leveloffset=+2]
