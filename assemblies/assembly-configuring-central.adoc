...
include::{enterprise-dir}/admin-and-config/business-central-settings-security-policy-con.adoc[leveloffset=+2]
include::{enterprise-dir}/admin-and-config/business-central-settings-security-provider-con.adoc[leveloffset=+2]
include::{enterprise-dir}/admin-and-config/business-central-settings-security-provider-EAP-proc.adoc[leveloffset=+3]
include::{enterprise-dir}/admin-and-config/business-central-settings-security-provider-tomcat-proc.adoc[leveloffset=+3]
