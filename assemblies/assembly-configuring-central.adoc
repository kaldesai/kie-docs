...
include::{shared-dir}/Workbench/SecurityManagement/configuring-EAP-security-management-provider-property-files-proc.adoc[leveloffset=+3]
include::{shared-dir}/Workbench/SecurityManagement/configuring-EAP-security-management-provider-CLI-mode-proc.adoc[leveloffset=+3]
